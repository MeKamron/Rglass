...
(function (h) {
    ...
    function ka(a, b, c) {
        ...
        a = -1 !== h.inArray("", b.asSorting);
        c = -1 !== h.inArray("", b.asSorting);
    }
    function $(a) {
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "Jadval bo'yicha ma'lumot yo'q",
            sInfo: "Ko'rsatilyapdi: _START_ dan _END_ gacha. <br> Jami: _TOTAL_ ta buyurtma",
            sInfoEmpty: "Ko'rsatilyapdi: 0 dan 0 gacha <br> Jami: 0 ta buyurtma",
            sInfoFiltered: "( _MAX_ tadan filterlandi)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "_MENU_",
            sLoadingRecords: "Yuklanyabdi...",
            sProcessing: "Qidirilyabdi...",
            sSearch: "",
            sSearchPlaceholder: "Qidirish...",
            sUrl: "",
